...
class ALM_User(Enum):
    ...
    SCRIPT_NOT_FOUND = "54902: script not found"    
    SCRIPT_ENV_NOT_FOUND = "50202: can not find SCR_DIR var."    
    NO_PERMISSION = "52118: No permission to access this file"        
    ...
    SAFETY_MOTORH_3 = "52145: NOT Detected, please check the Charge Spot"    
    SAFETY_MOTORH_4 = "50204: Too much distance"
    CMD_INTERVAL_DUPLICATED = "54023: MotorCmd duplicated."
    ALREADY_FINISHED_CMD_POS = "54022: Motor Pos is already on the position"
    NODE_NOT_FOUND = "52163: Node not found on this position"
