...
class ALM_Fatal(Enum):
    ...
    MAP_FORMAT_INVALID = "50106: map format invalid"
...
class ALM_User(Enum):
    ...
    TRAY360_SAFETY = "54007: Tray Rotate Safety"
    OUT_OF_SERVING_RANGE = "54028: Not able to serve the location"
    TRAYDOOR_SAFETY = "54006: Lift Down is required before DoorOpen"
    ...
    ROBOT_JITTER_STATIONARY = "54014: jitter occurs when robot is stationary"
    RS485_HARDWARE_ERROR = "54016: RS485 hardware error"
    DO_HARDWARE_ERROR = "54017: DO hardware error"
    REFLECTORS_IN_MAP_NOT_ENOUGH = "54018: reflectors in map not enough"
    LESS_THAN_3_REFLECTORS_DETECTED = "54019: less than 3 reflectors detected"
    REFLECTORS_MATCH_FAILED = "54020: reflectors match failed, please set right init pose"
    ABNORMAL_CAN_DATA = "54022: abnormal can data"
    ABNORMAL_SONIC_DATA = "54023: abnormal sonic data"
    ...
    PGV_CANNOT_FIND_CODES = "54070: PGV cannot find codes"
