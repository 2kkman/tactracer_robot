...
distortion = "distortion_coefficients.npy"
...
def decode_video():
    ...
    for camIdx in range(cam_count):
        ...
        lsImagePublishers.append(
            rospy.Publisher(img_publish_name, Image, queue_size=10)
        )
        stride = 0
                        ...
                        if bScanBarcd:
                            ...
                            for i in range(len(ids)):
                                ...
                                frame = cv2.drawFrameAxes(
                                    frame, k, d, rvecs[i], tvecs[i], arucoSizeMeter
                                )
                                ...
                                y_distance = round(
                                    np_numbers[i][0][1] * meter_to_milimeter
                                )
                                z_distance = round(
