...
class MsgStateView(MethodView):
    ...
    def get(self):
        ...
        return jsonify({"data": getCurrentTime()})
    


class MsgControlView(MethodView):
    def post(self):
